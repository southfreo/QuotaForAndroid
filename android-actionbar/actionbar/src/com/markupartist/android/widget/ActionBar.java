...
public class ActionBar extends RelativeLayout implements OnClickListener {
    ...
    public static class ClickAction extends AbstractAction {
        ...
        public ClickAction(Context context, View.OnClickListener clicker, int drawable) {
            super(drawable);
            mContext = context;
            mClicker = clicker;
        }
    ...
    public static class IntentBack extends AbstractAction {
        private Context mContext;
        private Activity mActivity;

        public IntentBack(Context context, Activity activity, int drawable) {
            super(drawable);
            mActivity = activity;
        }
    ...
    public static class DialogAction extends AbstractAction {
        ...
        public DialogAction(Context context, Class<?> cls, int drawable) {
            super(drawable);
            mContext = context;
            mDialog = cls.getName();
        }
        ...
        public void performAction(View view) {
            try {
                //Dialog nDialog = (Dialog) Class.forName(mDialog);
            	Class cl = Class.forName(mDialog);
                java.lang.reflect.Constructor co = cl.getConstructor(new Class[]{Context.class});
                Dialog nDialog =  (Dialog)co.newInstance(mContext);
